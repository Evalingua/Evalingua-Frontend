          ...
          <div className="w-full lg:block lg:w-1/2">
            <div className="py-2 lg:py-17.5 px-10 lg:px-26 text-center">
              ...
              <p className="2xl:px-20">
                Plataforma de asistencia a terapeutas en la evaluación
                fonética-fonológica
              </p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                  <button
                    ...
                    className="flex justify-center w-full cursor-pointer rounded-lg bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:bg-primary disabled:bg-opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? 
                    <svg
                      className="animate-spin w-5 h-5 mr-3 border-b-2 border-white rounded-full"
