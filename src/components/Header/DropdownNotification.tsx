...
const DropdownNotification = () => {
  ...
  const handlePrivateNotification = (notification: NotificationDTO) => {
    setNotifications((prev) => [notification, ...prev]);
    setNotifying(true);
  };

  const handleGlobalNotification = (notification: NotificationDTO) => {
    setNotifications((prev) => [notification, ...prev]);
    setNotifying(true);
  };
  ...
  useNotifications({
    ...
    onGlobalNotification: handleGlobalNotification,
  });
